...
$IP = "$NetworkPortion.132"
$ComputerName = "Spiderman"
...
New-LocalUser "PeterParker" -FullName "Peter Parker" -Description "Spiderman, local account" -Password $SecureStringPassword2
Start-Sleep -Seconds 30
Add-LocalGroupMember -Group "Administrators" -Member "PeterParker"
